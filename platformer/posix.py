...
class BasePosix(Platform):
    ...
    def gen_makefile(self, cfiles, eci, exe_name=None, path=None,
                     shared=False, proj_dir=None, proj_main_function=None):
        ...
        projpath = py.path.local(proj_dir)
        ...
        rel_includedirs = [rel(incldir) for incldir in
                           self.preprocess_include_dirs(eci.include_dirs)]
        rel_libdirs = [rel(libdir) for libdir in
